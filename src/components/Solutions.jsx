...
function Solutions() {
  return (
    <div className='flex flex-col items-center'>
      <div id="solutions" className='mt-14 mx-4 md:mx-16 lg:mx-28 mb-10 flex flex-col lg:flex-row gap-10 lg:gap-48 font-sofia box-border'>
        <div className='flex items-center justify-center gap-8 min-w-64'>
          <div>
            <img src={Person1} alt="Person 1" className='w-full max-w-[21rem] rounded-lg shadow-[0_0_75px_-30px_rgba(0,0,0,0.75)]' />
            <img src={Person2} alt="Person 2" className='w-full max-w-[21rem] rounded-lg mt-8 shadow-[0_0_75px_-30px_rgba(0,0,0,0.75)]' />
          </div>
          <div>
            <img src={Person3} alt="Person 3" className='w-full max-w-[21rem] rounded-lg shadow-[0_0_75px_-30px_rgba(0,0,0,0.75)]' />
            <img src={Person4} alt="Person 4" className='w-full max-w-[21rem] rounded-lg mt-8 shadow-[0_0_50px_-30px_rgba(0,0,0,0.75)]' />
          </div>
        </div>
      ...
      <div className='mt-20 mx-4 md:mx-16 lg:mx-28 mb-10 flex flex-col lg:flex-row gap-10 lg:gap-48 font-sofia'>
        ...
        <div className='flex flex-col justify-around items-center lg:items-end lg:ml-72'>
